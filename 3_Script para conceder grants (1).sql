DECLARE
  ...
  V_USER          VARCHAR2(30) := 'ASTI200USR';     -- Nome do usuário do sistema
  V_SCHEMA        VARCHAR2(30) := 'ASTI200';          -- Schema principal do sistema
  V_SCHEMA_AUDIT  VARCHAR2(30) := 'ASTI200_AUDIT';    -- Schema de auditoria do sistema
BEGIN
